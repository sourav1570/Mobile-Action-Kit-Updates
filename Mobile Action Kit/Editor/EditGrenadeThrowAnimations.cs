...
{
    public class EditGrenadeThrowAnimations : EditorWindow
    {
        ...
        private AnimationClip GrenadeThrow;
         

        private Vector2 scrollPosition;
        Animator anim;

        [MenuItem("Tools/Mobile Action Kit/Player/Grenade/Edit Grenade Animations", priority = 6)]
        private static void Init()
        {
            EditGrenadeThrowAnimations window = (EditGrenadeThrowAnimations)EditorWindow.GetWindow(typeof(EditGrenadeThrowAnimations));
            window.titleContent = new GUIContent("Edit Grenade Animations");
            window.Show();
        }
        private void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("GrenadeThrow", labelStyle, GUILayout.Width(labelWidth));
            GrenadeThrow = (AnimationClip)EditorGUILayout.ObjectField(GrenadeThrow, typeof(AnimationClip), true, GUILayout.Width(fieldWidth));
            GUILayout.EndHorizontal();
            ...
            {
                SaveAnimations();
                EditorWindow.GetWindow<EditGrenadeThrowAnimations>().Close();
            }
        ...
        private void ExportAnimations()
        {
            ...
            GrenadeThrow = GetAnimationClipByKeyword(animatorController, "Throw");
        ...
        private void SaveAnimations()
        {
            ...
            SetAnimationClipByKeyword(animatorController, "Throw", GrenadeThrow);
