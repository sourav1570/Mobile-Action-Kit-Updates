...
{
    [CustomEditor(typeof(CreateMulti_PurchasableItem))]
    public class CreateMultiTimePurchase_PurchasableEditorScript : Editor
    {
        private CreateMulti_PurchasableItem CreateMultiItem_PurchasableItemHelper;

        private void OnEnable()
        {
            CreateMultiItem_PurchasableItemHelper = (CreateMulti_PurchasableItem)target;
        }
        ...
        {
            CreateMulti_PurchasableItem script = (CreateMulti_PurchasableItem)target;
            ...
            if (GUILayout.Button("SAVE THE CHANGES", GetButtonStyle(), GUILayout.Width(450), GUILayout.Height(40)))
            {
                ...
                string prefabPath = "Assets/Mobile Action Kit/Editor/Editor Prefabs/ItemsFunctionSavingPrefabs/CreateMultiItemPurchasable.prefab";
                ...
                if (existingPrefab != null && PlayerPrefs.HasKey(prefabKey))
                {
                    ...
                    CreateMulti_PurchasableItem existingPrefabScript = existingPrefab.GetComponent<CreateMulti_PurchasableItem>();
                ...
                else
                {
                    ...
                    if (prefabAsset != null)
                    {
                        ...
                        CreateMulti_PurchasableItem newPrefabScript = prefabAsset.GetComponent<CreateMulti_PurchasableItem>();
        ...
        private void DisplayConsumableItemsList()
        {
            ...
            for (int i = 0; i < CreateMultiItem_PurchasableItemHelper.CreateItem.Count; i++)
            {
                ...
                CreateMultiItemClass item = CreateMultiItem_PurchasableItemHelper.CreateItem[i];
                ...
                if (item != null)
                {
                    ...
                    item.NumberOfPurchasesText = (TextMeshProUGUI)EditorGUILayout.ObjectField("Number Of Purchases Text", item.NumberOfPurchasesText, typeof(TextMeshProUGUI), true);
                    item.DebugNumberOfPurchases = EditorGUILayout.IntField("Debug Number Of Purchases", item.DebugNumberOfPurchases);
